...
public class Controller implements CommandListener {
	...
	/**
	 * renders the unchangeable part of the View (GUI), which is independent of user
	 * interaction
	 */
	...
	/**
	 * Provides the main interactions between the View and the Data Model part of
	 * the interface CommandListener
	 * 
	 * @see shoppingCartMVC.CommandListener#doAction(shoppingCartMVC.ActionCode,
	 *      java.lang.Object[])
	 */
	...
	public Object[] doAction(ActionCode actionCode, Object[] args) throws Exception {
		...
		case getProductInfobyId:
			return (getProductInfobyId((int) args[0]));
		case RemoveItemFromShoppingCart:
			removeItemFromShoppingCart((int) args[0]);
			return null;
		case UpdateItemQuantity:
			updateItemQty((int) args[0], (int) args[1]);
			return null;
		case getCalculation:
			getCalculation();
			return null;
		case AddItemToShoppingCart:
			addItemToShoppingCart((int) args[0]);
			return null;
		case setDiscounts:
			setDiscounts((double) args[0], (double) args[1]);
			return null;
		case getDiscounts:
			return (getDiscounts());
	...
	/**
	 * Retrieves the information about a product by its id id is a unique identifier
	 * of a product. It is stored in the hidden fields of the GUI components
	 */
	...
	/**
	 * Performs the calculation in the Data Model and renders its results in the
	 * View
	 */
	 ...
	 * 
	 * @returns a 2-dim array whose rows contains product id, product quantity and
	 *          their product(for the MVC pattern purity reasons this multiplication
	 *          is performed in the Data Model:)
	 */
