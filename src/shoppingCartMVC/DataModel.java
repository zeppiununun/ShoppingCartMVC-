...
/**
 * the main class respresenting the data structure of the project model of the
 * shopping cart + test collection of products
 */
...
//get a product id by an index in productList
	...
	/**
	 * returns the number of positions in the shopping card
	 * 
	 * @return
	 */
	...
	/**
	 * initializes the data model with some test data adds some products to the
	 * product list creates an empty shopping cart
	 */
